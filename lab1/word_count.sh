...
# Step 1: Going back to the home directory and create a folder to be used for unziping words.zip
cd ../..
directory="words"
...
# Step 3: Create the results folder at the home directory
# Only create if the results directory does not exist
if [ ! -d "results" ]; then
  mkdir "results"
fi

# Step 4: Looping through all files in a directory and count words in each, save the results
